...
exports.findProjectRoot = function (start) {
    ...
    var root = start.slice(0, position === -1 ? undefined : position);
...
exports.installHooks = function (hooks, root) {
    ...
    Fs.writeFileSync(hookRoot + '/systempath', shellPath.sync());
...
exports.configureHook = function (hook, defaults, root) {
    ...
    package[hook] = arrayUnique(existingHookValues.concat(newHookValues));
